...
function user_post_type() {
	...
	$labels = array(
		...
		'singular_name'         => _x( 'User', 'User Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Events', 'text_domain' ),
		'name_admin_bar'        => __( 'User', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'User', 'text_domain' ),
		'description'           => __( 'User Description', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'user_post_type', 0 );

/*
-----------------------------------------------------------------------------------------------
Add meta box in custom post users
-----------------------------------------------------------------------------------------------
*/
add_action( 'add_meta_boxes', 'cd_meta_box_add' );
function cd_meta_box_add()
{
	add_meta_box( 'my-meta-box-id', 'My First Meta Box', 'cd_meta_box_cb', 'user', 'normal', 'high' );
}

function cd_meta_box_cb()
{
?>
    Name : <input name="name" type="text" value="<?php echo get_post_meta($object->ID, "name", true); ?>"
/><br><br>
    Adress : <input type="text"/><br><br>
    Start : <input type="time"/><br><br>
    End : <input type="time"/><br><br>
    <?php
}
...
function cd_meta_box_save( $post_id )
{
	...
	$meata_post_name="";
    if(isset($_POST['name'])){
       $meata_post_name=$_POST['name'];
    }
   update_post_meta($post_id,"meata_post_name",$meata_post_name);
}
